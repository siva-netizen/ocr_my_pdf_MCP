...
from nodes import validate_pdf_node, run_ocr_node, extract_text_node, format_response_node, extract_images_node, caption_images_node, merge_content_node
...
graph.add_edge("merge_content_node", "format_response_node")
